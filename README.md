...
<p align="center"> <img src="S16.png" width="900"/> <br> <em>Рисунок 3 -Подключение к phpMyAdmin, в левой панели видна база данных netology_db, созданная в кластере MySQL. Подтверждение работоспособности связки Kubernetes → phpMyAdmin → Managed MySQL через внутреннюю сеть VPC</em> </p>
